...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 25, 2017 lúc 06:30 AM
...
--
-- Cấu trúc bảng cho bảng `companies_sections`
--

CREATE TABLE `companies_sections` (
  `company_id` int(11) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `companies_social_networks`
--
...
--
-- Cấu trúc bảng cho bảng `recruitments_sections`
--

CREATE TABLE `recruitments_sections` (
  `recruitment_id` int(11) NOT NULL,
  `section_id` int(11) NOT NULL,
  `content` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Chỉ mục cho bảng `companies_sections`
--
ALTER TABLE `companies_sections`
  ADD PRIMARY KEY (`company_id`,`section_id`),
  ADD KEY `section_id` (`section_id`);

--
-- Chỉ mục cho bảng `companies_social_networks`
--
...
--
-- Chỉ mục cho bảng `recruitments_sections`
--
ALTER TABLE `recruitments_sections`
  ADD PRIMARY KEY (`recruitment_id`,`section_id`),
  ADD KEY `section_id` (`section_id`);
...
--
-- AUTO_INCREMENT cho bảng `companies_social_networks`
--
ALTER TABLE `companies_social_networks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `companies_sections`
--
ALTER TABLE `companies_sections`
  ADD CONSTRAINT `companies_sections_ibfk_1` FOREIGN KEY (`section_id`) REFERENCES `section` (`id`),
  ADD CONSTRAINT `companies_sections_ibfk_2` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`);

--
-- Các ràng buộc cho bảng `companies_social_networks`
--
ALTER TABLE `companies_social_networks`
  ADD CONSTRAINT `companies_social_networks_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`);
...
--
-- Các ràng buộc cho bảng `recruitments_sections`
--
ALTER TABLE `recruitments_sections`
  ADD CONSTRAINT `recruitments_sections_ibfk_1` FOREIGN KEY (`section_id`) REFERENCES `section` (`id`),
  ADD CONSTRAINT `recruitments_sections_ibfk_2` FOREIGN KEY (`recruitment_id`) REFERENCES `recruitments` (`id`);
