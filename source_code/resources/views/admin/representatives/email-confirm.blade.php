				...
				<tbody>
					...
					<tr>
						<td colspan="2" style="padding:30px 0; border-bottom:1px solid #e9edee;">
							...
							<p style="font-size: 20px; margin:0 10px 10px 10px;padding:0;">Công ty <strong>{{$company->name}}</strong> đã được cấp phép sử dụng dịch vụ tại website VanLang E-Recruiting </p>
							<p>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="padding:30px 0;">
								<span style="color:#1d2227;line-height:28px;font-size:21px;font-weight:400;">Người đại diện: {{$representative->name}}</span>
								<br>
								<span style="color:#1d2227;line-height:28px;font-size:21px;margin:12px 10px 20px 10px;font-weight:400;">Chức vụ:  {{$representative->position}}</span>
