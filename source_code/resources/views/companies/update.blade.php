...
<section>
    <div class="container">
        <div class="col-md-3 col-sm-12 col-xs-12">
            <form enctype="multipart/form-data" id="upload-logo-form" role="form" method="POST" action="" >
                <center>
                    <div class="form-group">
                        <input type="file" class="dropify" data-default-file="assets/img/fpt.jpg" name="logo">
...
<script type="text/javascript">
    ...
    $('#upload-logo-form').bind("change", function () {
